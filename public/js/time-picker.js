...
(function ($) {
    $.fn.scrollTo = function (elem, speed) {
        $(this).animate({
            scrollTop: $(this).scrollTop() - $(this).offset().top - $(this).offset().top
        ...
        function init(timeInputs) {
                    ...
                    function timeClick() {
                        ...
                        function setTime() {
							...
							meridianValue = meridianActive.text().trim();
                                // timeIn24hr = to24hrFormat(hourValue, minuteValue, secondValue, meridianValue);
            ...
            function changeTimeInPopup(clickedTime, scroll) {
                ...
                if (scroll === 'scroll-enable') {
					...
					$(".nj-timepick__seconds-boxes").scrollTo(boxesToActivate[3]);
                }
            }

            // function to24hrFormat(hour, minute, second, meridian) {
            //     if (hour === '12') hour = '00';
    ...
    function timePicker() {
        var timeInputs = $('input[type="button"');
